...
export const BentoCardGrid = ({ children, gridRef, className = "grid gap-2 p-3 max-w-[54rem]" }) => (
    <div
        className={`bento-section w-full select-none relative mx-auto ${className}`}
                        ...
                        {cardData.map((card, index) => {
                            ...
                            return (
                                <div key={index} className={baseClassName} style={cardStyle}>
                                    {/* Fallback simple card implementation if stars disabled */}
                                    <div className="card__header flex justify-between gap-3 relative text-white">
                                        <span className="card__label text-base">{card.label}</span>
                                    </div>
                                    <div className="card__content flex flex-col relative text-white">
